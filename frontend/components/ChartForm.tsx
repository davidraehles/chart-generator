  ...
  return (
    <div>
      ...
      <div className="-mx-4 md:-mx-8 px-6 md:px-10 pt-8 pb-7 mb-7"
        style={{ background: "rgba(95,118,128,0.07)" }}>
        ...
        <div className="pt-4" style={{ borderTop: `0.5px solid rgba(95,118,128,0.2)` }}>
          <p className="text-sm font-semibold" style={{ color: DARK }}>Human Design für den Businessalltag übersetzt von Silke Stupperich</p>
          <p className="text-xs mt-1 leading-relaxed" style={{ color: MUTED }}>
            20 Jahre Kommunikation, Change & Transformation auf Top-Management-Ebene<br />
      ...
      <p className="mt-4 text-center text-xs" style={{ color: "#C4BEB8" }}>
        Deine Angaben werden ausschließlich zur Berechnung verwendet und nicht gespeichert. Das Ergebnis existiert nur in der Browser-Session. Lade dein Ergebnis als PDF herunter und speichere es lokal, um es zu behalten.
      </p>
